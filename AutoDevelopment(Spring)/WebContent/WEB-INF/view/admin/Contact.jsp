	...
	<div class="bg-dark" id="wrap">
		...
		<!-- 	<div id="content" class="bg-container">
			...
			<div class="card"
				...
				<div class="card-header bg-white">Contact</div>
				<div class="card-block m-t-35">
					<h5>Address:</h5>
					
					<p>405, Sigma Legacy, Above Nissan Motors Showroom, IIM Road,
						Nr. Panjrapole Cross Rd, Amabawadi,Ahmedabad - 380015.</p>
					<h5>Phone:</h5>
					
					<p class="text-justify">079-32446066, 9428503923</p>
					<h5>Email:</h5>
					
					<p class="text-justify">innoventaa.technocrats@gmail.com</p>
			...
			<!-- <div id="content" class="bg-container"
				style="margin-top: 110px; max-height: 50px;">
				<header class="head">
				<div class="main-bar row" style="height: 100px;">
					<div class="col-xs-6" align="right" style="float: right;">
