				...
				<div class="row">
					<div class="col-lg-8 push-lg-2 col-md-10 push-md-1 col-sm-12">
						...
						<div class="bg-white login_content login_border_radius">
							<form action="j_spring_security_check" id="" method="post"
								class="">
								...
								<div class="form-group">
									...
									<div class="input-group">
										<span class="input-group-addon addon_password"><i
											class="fa fa-lock text-primary"></i></span> <input type="password"
											class="form-control form-control-md" id="password"
							...
							<div class="form-group">
								...
								<a href="forgot_password.html"
									class="custom-control-description forgottxt_clr">Forgot
									password?</a>

							</div>

							<div class="form-group">
								<label class="form-control-label">Don't you have an
									Account? </label> <a href='reg.html'><b>Sign Up</b></a>
							</div>
						</div>
					</div>
				</div>
									...
									<div class="card-block m-t-35">
										<form action="j_spring_security_check" method="post"
											...
											<div class="input-group">
												<span class="input-group-addon input_email"><i
													class="fa fa-envelope text-primary"></i></span> <input type="text"
													class="form-control  form-control-md" name="email"
													id="email" placeholder="E-mail">
											</div>
										</div> -->
											<div class="form-group row">
												<div class="col-lg-4  text-lg-right">
													<label for="required2" class="form-control-label">Email
														*</label>
												</div>
												<div class="col-lg-4">
											...
											<div class="form-group row">
												<div class="col-lg-4  text-lg-right">
													<label for="required2" class="form-control-label">Password
														*</label>
												</div>
												<div class="col-lg-4">
