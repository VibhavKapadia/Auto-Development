...
<body>
							...
							<div class="col-xl-12">
								<div class="card">
									...
									<div class="card-block m-t-35">
										...
										<f:form action="insertCity.html" data-parsley-validate=""
											novalidate="" class="form-horizontal login_validator"
											id="form_block_validator" method="get" modelAttribute="city"
											name="addCity">
											...
											<div class="form-group row">
												...
												<div class="col-xl-4">
													...
													<select style=""
														...
														onchange="load()" id="countryId" name="countryId">
											...
											<div class="form-group row">
												...
												<div class="col-lg-4  text-lg-right">
													<label for="required2" class="form-control-label">City
														Name *</label>
												</div>
												<div class="col-lg-4">
													<f:input path="cityName" placeholder="Type and hit Enter.."
														class="form-control" required="" id="required2" />
												</div>
											</div>
											<div class="form-group row">
												<div class="col-lg-4 text-lg-right">
												...
												<div class="col-lg-4">
													<f:input path="cityDescription"
														placeholder="Type and hit Enter.." class="form-control"
														required="" id="required2" />
	...
	<script>
			...
			xmlhttp.onreadystatechange = function() {
				if (xmlhttp.readyState == 4) {
					...
					for (i = 0; i < jsonObj.length; i++) {
						...
						document.addCity.stateId.options.add(createOption);
		...
		function removeAllState() {
			...
			var removeState = document.addCity.stateId.options.length;
			for (i = removeState; i > 0; i--) {
				document.addCity.stateId.remove(i);
			}
		}
	</script>
