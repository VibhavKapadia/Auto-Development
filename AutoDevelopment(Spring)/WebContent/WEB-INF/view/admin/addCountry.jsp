							...
							<div class="col-xl-12">
								<div class="card">
									...
									<div class="card-block m-t-35">
										<f:form action="insertCountry.html" data-parsley-validate=""
											novalidate="" class="form-horizontal login_validator"
											id="form_block_validator" modelAttribute="country" method="get">
											
											<div class="form-group row">
												<div class="col-lg-4  text-lg-right">
													<label for="required2" class="form-control-label">Country
														Name *</label>
												</div>
												<div class="col-lg-4">
													<f:input path="countryName"
														placeholder="Type and hit Enter.." class="form-control" required="required" id="required2"/>
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-lg-4">
													<f:input path="countryDescription"
														placeholder="Type and hit Enter.." class="form-control" required="required" id="required2"/>
												</div>
											</div>
