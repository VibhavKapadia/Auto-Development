...
<body>
	<%
		Integer i = (Integer) session.getAttribute("fadeinfadeoutaddfieldcount");
	...
	<div id="toast-container" class="toast-top-right">
		<div class="toast toast-success" aria-live="polite"
			...
			<div class="toast-message">Field added!</div>
		</div>
	</div>
				...
				<div class="main-bar row">
					<div class="col-sm-5 col-lg-6">
						<h4 class="nav_top_align">
							<i class="fa fa-pencil"></i> Add Fields
						</h4>
					</div>
					<div class="col-sm-7 col-lg-6">
						<ol class="breadcrumb float-xs-right nav_breadcrumb_top_align">
							...
							<li class="breadcrumb-item"><a href="addField.html">Add
									Field</a></li>
							...
							<div class="col-xl-12">
								<div class="card">
									<div class="card-header bg-white">
										<i class="fa fa-file-text-o"></i> ADD Field
									</div>
									<div class="card-block m-t-35">
										<%-- <form action="addCountry.html"
											class="form-horizontal  login_validator"
											id="form_block_validator"> --%>
										<f:form action="insertField.html" data-parsley-validate=""
											novalidate="" class="form-horizontal login_validator"
											id="form_block_validator" modelAttribute="field" method="get">
											...
											<div class="form-group row">
												...
												<div class="col-lg-4">
													<f:input path="fieldName"
														placeholder="Type and hit Enter.." class="form-control"
														required="required" id="required2" maxlength="15"/>
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-lg-4">
													<f:input path="fieldDescription"
														placeholder="Type and hit Enter.." class="form-control"
														required="required" id="required2" maxlength="20"/>
												</div>
											</div>
