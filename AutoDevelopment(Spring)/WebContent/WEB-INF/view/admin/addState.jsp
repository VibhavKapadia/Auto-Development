							...
							<div class="col-xl-12">
								<div class="card">
									...
									<div class="card-block m-t-35">
										...
										<f:form action="insertState.html" data-parsley-validate=""
											novalidate="" class="form-horizontal login_validator"
											method="get" id="form_block_validator" modelAttribute="state">
												...
												<div class="col-xl-4">
													...
													<f:select style="" id="sport"
														...
														<c:forEach items="${sessionScope.countryList}" var="r">
															<f:option value="${r.countryId}">${r.countryName}</f:option>
														</c:forEach>
