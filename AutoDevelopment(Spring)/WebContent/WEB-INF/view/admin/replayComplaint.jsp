...
<script>
	function readfile() {
		...
		if (filepath == "") {
			...
			xmlhttp.open("get", "openfile.html?filepath=" + filepath, true);
			xmlhttp.send();
		}
				...
				<div class="main-bar row">
					<div class="col-sm-5 col-lg-6">
						<h4 class="nav_top_align">
							<i class="fa fa-pencil"></i> Reply Complaint
						</h4>
					</div>
					<div class="col-sm-7 col-lg-6">
						<ol class="breadcrumb float-xs-right nav_breadcrumb_top_align">
							...
							<li class="active breadcrumb-item">Reply Complaint</li>
						</ol>
					</div>
				</div>
				</header>
							...
							<div class="col-xl-12">
								<div class="card">
									<div class="card-header bg-white">
										<i class="fa fa-file-text-o"></i> Reply
									</div>
									<div class="card-block m-t-35">
										...
										<f:form modelAttribute="complaintList"
											action="updateComplaint.html" method="post"
											class="form-horizontal login_validator"
											id="form_block_validator" enctype="multipart/form-data">



											<div class="form-group row">
												<div class="col-lg-4  text-lg-right">
													<label for="required2" class="form-control-label">Complaint
														Subject *</label>
												</div>
											...
											<div class="form-group row">
												<div class="col-lg-4 text-lg-right">
													<label for="range" class="form-control-label">Complaint
														Description *</label>
												</div>

												<div class="col-lg-4">

													<f:input path="complaintDescription"
											...
											<%
												String attachmentPath = session.getAttribute("attachmentPath").toString();
											...
											<div class="form-group row">
												...
												<div class="col-lg-4">
													...
													<input type="hidden" value="${sessionScope.attachmentPath}"
														id="path"> <a
														href="${sessionScope.attachmentPath}" onclick="readfile()">Read
														File</a>
											...
											<div class="form-group row">
												...
												<div class="col-lg-4">
													...
													<f:textarea path="complaintReplay"
														placeholder="Type and hit Enter.." class="form-control"
														required="required" id="required2" />
											...
											<f:input type="hidden" path="complaintId"></f:input>
