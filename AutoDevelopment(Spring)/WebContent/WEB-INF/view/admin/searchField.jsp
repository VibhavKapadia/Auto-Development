...
<body class="datatable_page">
	...
	<div id="toast-container" class="toast-top-right">
		<div class="toast toast-success" aria-live="polite"
			...
			<div class="toast-message">Field Updated!</div>
		</div>
	</div>
	...
	<div id="toast-container" class="toast-top-right">
		<div class="toast toast-success" aria-live="polite"
			...
			<div class="toast-message">Field deleted!</div>
		</div>
	</div>
				...
				<div class="main-bar row">
					<div class="col-lg-6 col-md-4 col-sm-4">
						<h4 class="nav_top_align">
							<i class="fa fa-th"></i> Manage Fields
						</h4>
					</div>
							...
							<div class="col-xs-12 data_tables">
								...
								<div class="card">
									<div class="card-header bg-white">
										<i class="fa fa-table"></i> Manage Fields
									</div>
												...
												<tbody>
													<c:forEach items="${ls}" var="r">
														...
														<tr>
															...
															<td>${r.fieldName}</td>
															<td><a href="editField.html?fieldId=${r.fieldId}">Update</a></td>
															<td><a href="deleteField.html?fieldId=${r.fieldId}">Delete</a></td>
														</tr>
													</c:forEach>
												</tbody>
											</table>
