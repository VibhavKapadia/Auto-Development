...
<body class="datatable_page">
	<%
		Integer i = (Integer) session.getAttribute("fadeinfadeoutupdatefieldcount");
	...
	<div id="toast-container" class="toast-top-right">
		<div class="toast toast-success" aria-live="polite"
			...
			<div class="toast-message">User Activated!</div>
		</div>
	</div>
	...
	%>
	<%
		Integer k = (Integer) session.getAttribute("fadeinfadeoutdeletefieldcount");
		if (k != 0) {
	%>
	...
	<div id="toast-container" class="toast-top-right">
		<div class="toast toast-success" aria-live="polite"
			...
			<div class="toast-message">User Bloacked!</div>
		</div>
	</div>
												...
												<tbody>
													<c:forEach items="${regList}" var="r">
														...
														<tr>
															...
															<td>${r.cityVO.cityName}</td> --%>
															<%-- <td><a href="editReg.html?regId=${r.regId}">Update</a></td>
 --%>
															<c:if test="${r.delstatus eq 'Active'}">
																<td><a href="deleteReg.html?regId=${r.regId}">Active
																		User </a></td>
															</c:if>
															<c:if test="${r.delstatus eq 'Deactive'}">
																<td><a href="activeReg.html?regId=${r.regId}">Blocked
																		User </a></td>
															</c:if>
														</tr>
													</c:forEach>
