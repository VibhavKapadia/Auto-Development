...
<body>
	...
	<div id="toast-container" class="toast-top-right">
		<div class="toast toast-success" aria-live="polite"
			...
			<div class="toast-message">Thanks For Feedback!</div>
		</div>
	</div>
				...
				<div class="main-bar row">
					...
					<div class="col-sm-7 col-lg-6">
						<ol class="breadcrumb float-xs-right nav_breadcrumb_top_align">
							...
							<li class="active breadcrumb-item">Feedback</li>
						</ol>
					</div>
				</div>
				</header>
							...
							<div class="col-xl-12">
								<div class="card">
									...
									<div class="card-block m-t-35">
										<f:form action="insertFeedback.html" data-parsley-validate=""
											novalidate="" class="form-horizontal login_validator"
											id="form_block_validator" modelAttribute="feedback"
											method="get">

											<div class="form-group row">
												<div class="col-lg-4  text-lg-right">
													<label for="required2" class="form-control-label">Subject
														Name *</label>
												</div>
												<div class="col-lg-4">
													<f:input path="feedbackSubject"
											...
											<div class="form-group row">
												<div class="col-lg-4 text-lg-right">
													<label for="range" class="form-control-label">Feedback
														Description *</label>
												</div>
												<div class="col-lg-4">
