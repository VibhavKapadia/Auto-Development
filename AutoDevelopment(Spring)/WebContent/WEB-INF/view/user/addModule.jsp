...
<body>
	...
	<div id="toast-container" class="toast-top-right">
		<div class="toast toast-success" aria-live="polite"
			...
			<div class="toast-message">Module Added!</div>
		</div>
	</div>
				...
				<div class="main-bar row">
					...
					<div class="col-sm-7 col-lg-6">
						<ol class="breadcrumb float-xs-right nav_breadcrumb_top_align">
							...
							<li class="active breadcrumb-item">Add Module</li>
						</ol>
					</div>
				</div>
				</header>
							...
							<div class="col-xl-12">
								<div class="card">
									<div class="card-header bg-white">
										<i class="fa fa-file-text-o"></i> &nbsp;Add Module
									</div>
									<div class="card-block m-t-35">
										<%-- <form action="#" class="form-horizontal  login_validator"
											id="form_block_validator"> --%>
										<f:form action="insertModule.html" data-parsley-validate=""
											...
											<div class="form-group row">
												<div class="col-lg-4  text-lg-right">
													<label for="required2" class="form-control-label">Module
														Name *</label>
												</div>
												<div class="col-lg-4">
													...
													<f:input path="moduleName"
														...
														required="required" id="required2" maxlength="25" />
												</div>
											</div>
