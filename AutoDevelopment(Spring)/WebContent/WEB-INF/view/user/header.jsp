...
<div id="top">
 ...
 %>
						...
						<div class="dropdown-menu admire_admin">
							<a class="dropdown-item" href="javascript:accountsetting()"><i
								class="fa fa-sign-out"></i> Account Setting</a> <a
								class="dropdown-item" href="changepassword.html"><i
								class="fa fa-lock"></i> Change Password </a> <a
								class="dropdown-item" href="javascript:logout()"><i
						...
						<c:url var="accountsetting" value="/editReg.html" />
						<form action="${accountsetting}" method="post" id="form1">
							<input type="hidden" name="regId" value="<%=UserLoginId%>" />
						</form>
						<script>
			...
			<!-- <div
				class="collapse navbar-toggleable-sm col-xl-6 col-lg-6 hidden-md-down float-xl-right  top_menu"
				id="nav-content">
				<ul class="nav navbar-nav top_menubar">
					<li class="nav-item"><a class="nav-link text-white"
						href="mail_inbox.html"> <i class="fa fa-inbox"></i> <span
							class="quick_text">Inbox</span>
					</a></li>
					<li class="nav-item"><a class="nav-link text-white"
						href="mail_compose.html"> <i class="fa fa fa-edit"></i> <span
							class="quick_text">Compose</span>
					</a></li>
					<li class="nav-item"><a class="nav-link text-white"
						href="maps.html"> <i class="fa fa-map-marker"></i> <span
							class="quick_text">Maps</span>
					</a></li>
					<li class="nav-item"><a class="nav-link text-white"
						href="gallery.html"> <i class="fa fa-picture-o"></i> <span
							class="quick_text">Gallery</span>
					</a></li>
				</ul>
			</div> -->
		</div>
