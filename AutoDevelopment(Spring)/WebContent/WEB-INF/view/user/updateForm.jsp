...
<body>
						...
						<div class="row">
							<div class="col-xl-12">
								<div class="card">
									...
									<br>
									<f:form action="updateForm.html" data-parsley-validate=""
										novalidate="" class="form-horizontal login_validator"
										id="form_block_validator" modelAttribute="formlist"
										method="get">
 ...
 --%>
										<f:input path="formId" type="hidden" />
										<div class="form-group row">
