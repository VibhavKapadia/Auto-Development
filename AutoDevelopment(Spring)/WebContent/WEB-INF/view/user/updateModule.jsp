...
<body>
						...
						<div class="row">
							<div class="col-xl-12">
								<div class="card">
									...
									<br>
									<f:form action="updateModule.html" data-parsley-validate=""
										novalidate="" class="form-horizontal login_validator"
										id="form_block_validator" modelAttribute="modulelist"
										method="get">
										...
										<div class="col-xl-4">
											...
											<f:select style="" id="sport"
												...
												path="projectVO.projectId">
												
												<f:option value="">Select a project</f:option>
												<f:options items="${projectList}" itemLabel="projectName"
													itemValue="projectId" />
											</f:select>
 ...
 --%>
										<f:input path="moduleId" type="hidden" />
										<div class="form-group row">
