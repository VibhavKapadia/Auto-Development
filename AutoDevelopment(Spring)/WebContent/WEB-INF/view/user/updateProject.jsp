				...
				<div class="main-bar row">
					<div class="col-sm-5 col-lg-6">
						<h4 class="nav_top_align">
							<i class="fa fa-pencil"></i> Update Project
						</h4>
					</div>
					<div class="col-sm-7 col-lg-6">
						<ol class="breadcrumb float-xs-right nav_breadcrumb_top_align">
							...
							<li class="breadcrumb-item"><a href="Add">Search Project</a></li>
							<li class="active breadcrumb-item">Update Project</li>
						</ol>
					</div>
				</div>
				</header>
							...
							<div class="col-xl-12">
								<div class="card">
									<div class="card-header bg-white">
										<i class="fa fa-file-text-o"></i> Update Project
									</div>
									<div class="card-block m-t-35">
										...
										<f:form modelAttribute="projectlist"
											action="updateProject.html" method="get"
											class="form-horizontal login_validator"
											id="form_block_validator">
											...
											<div class="form-group row">
												<div class="col-lg-4 text-lg-right">
													<label for="range" class="form-control-label">Project
														Title *</label>
												</div>
											...
											<f:input type="hidden" path="projectId"></f:input>
